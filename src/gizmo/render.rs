...
pub(crate) struct GizmoDrawData(pub(crate) super::core::GizmoDrawData);
...
fn init_transform_gizmo_pipeline(world: &mut World) {
    world.init_resource::<TransformGizmoPipeline>();
}
